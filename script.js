...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function renderWidgets() {
    ...
    Object.entries(categories).forEach(([cat, val], index) => {
      ...
      widget.innerHTML = `
        ...
        <div class="widget-input-group">
          ...
          <button class="neumorphic-btn small add-expense-btn" data-category="${cat}">+</button>
        </div>
      `;
    ...
    document.querySelectorAll('.widget-amount-row .note-btn').forEach(btn => {
